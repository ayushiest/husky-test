...
export default function ShareImage() {
  const b64toBlob = (b64Data, contentType, sliceSize) => {
    ...
    console.log("byteCharacters", atob(imgBase64));
  ...
  const testWebShare = async ({ text, files: filesUrl }) => {
    let files;
    ...
    var file = b64toBlob(imgBase64, "image/jpeg");
  ...
  return (
    <div className="App">
      ...
      <button
        onClick={() =>
          testWebShare({
            text: "http://personal.psu.edu/xqz5228/jpg.jpg",
            files: "http://personal.psu.edu/xqz5228/jpg.jpg"
          })
        }
      >
        {" "}
